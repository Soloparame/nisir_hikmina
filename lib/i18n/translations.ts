...
const translationsSource = {
  am: {
    ...
    doctorAuth: {
      ...
      profileTitle: "መገለጫ",
      profileSub: "መረጃዎን ያርትዑ — ለውጦችዎ በአስተዳዳሪው ፓነልም ይታያሉ።",
      profileId: "የዶክተር መለያ",
      profileEmail: "ኢሜይል",
      profileName: "ስም",
      profileNameAm: "ስም (አማርኛ)",
      profileNameEn: "ስም (English)",
      profileSpecialty: "ስፔሻሊቲ",
      profileExperience: "ልምድ",
      profileLanguages: "ቋንቋዎች",
      profileBio: "ስለ እኔ",
      profileBioAm: "ስለ እኔ (አማርኛ)",
      profileBioEn: "Bio (English)",
      ...
      profileEditHint:
        "ስም፣ ባዮ፣ ፎቶ እና የሚገኙበትን ሰዓት ማርትዕ ይችላሉ። ኢሜይል እና ዶክተር መለያ በአስተዳዳሪ ብቻ ይቀየራሉ።",
      profileAvailability: "የሚገኙበት ሰዓት",
      profileMorning: "ጠዋት",
      profileAfternoon: "ከሰዓት በኋላ",
      profileEvening: "ማታ",
      profileUploadPhoto: "ፎቶ ይጫኑ",
      profileRemovePhoto: "ፎቶ አስወግድ",
      profileUploading: "በመጫን ላይ...",
      profileSave: "መገለጫ አስቀምጥ",
      profileSaving: "በማስቀመጥ ላይ...",
      profileSaved: "መገለጫ ተቀምጧል። አስተዳዳሪውም ያየዋል።",
  ...
  en: {
    ...
    home: {
      ...
      whatsNewTitle: "Health Education",
    ...
    doctorAuth: {
      ...
      profileSub: "Edit your professional details — changes sync with the admin panel.",
      profileId: "Doctor ID",
      profileEmail: "Email",
      profileName: "Name",
      profileNameAm: "Name (Amharic)",
      profileNameEn: "Name (English)",
      profileSpecialty: "Specialization",
      profileExperience: "Experience",
      profileLanguages: "Languages",
      profileBio: "About",
      profileBioAm: "About (Amharic)",
      profileBioEn: "Bio (English)",
      ...
      profileEditHint:
        "You can update your name, bio, photo, and availability. Email and Doctor ID can only be changed by the admin.",
      profileAvailability: "Availability",
      profileMorning: "Morning",
      profileAfternoon: "Afternoon",
      ...
      profileSaved: "Profile saved. The admin will see these updates too.",
